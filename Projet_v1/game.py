...
class Game:
    def __init__(self, players, difficulty="Facile"):
        ...
        with open("data/objectifs.json", "r", encoding="utf-8") as f:
            self.objectif = json.load(f)
    ...
    def claim_route(self, city1, city2, routes):# Un même joueur ne peut pas prendre 2 routes reliant les 2 mêmes villes.
        ...
        self.current_player.remaining_trains -= length
        ...
        player.score += self.SCORE_TABLE.get(length)
