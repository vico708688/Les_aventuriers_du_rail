...
class StartScreen:
    ...
    Fenêtre plein écran initiale affichant :
        - un fond personnalisé.
        - un menu pour choisir la difficulté.
        - un bouton central pour commencer le jeu.
    ...
    start_game()
        Lance l'interface principale du jeu
    """
    def __init__(self, root):
        """
        - Initialise la fenêtre en plein écran.
        - Charge et affiche une image de fond.
        - Crée un bouton de démarrage.
        - Crée un menu déroulant pour sélectionner la difficulté ("Facile" ou "Difficile").
        """
        self.root = root
    ...
    def start_game(self):
        """
        Vérifie que la difficulté a été choisie.

        Si non, affiche un message d’erreur
        Sinon :
            - Ferme l'écran d'accueil
            - Crée une instance de Game avec les joueurs
            - Lance l'interface principale du jeu (GameApp)
        """
